            ...
            <div className='bill_container'>
                ...
                <div className='bill_address_bar'>
                    ...
                    <div className='bill_address'>
                        ...
                        >
                            ...
                            //  onChange={(e) => onChangeHandler(e)} 
                             name='date' value={billData?.date} type='date' variant="outlined" />
                        </Box></span></h3>
                    </div>
                    <h1>
                        <Box
                    ...
                    >
                        ...
                        <TextField onChange={(e) => onChangeHandler(e)} name='client_address' value={billData.client_address} className='client_address_bar' id="outlined-multiline-static"
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <TextField size='small' onChange={(e) => onChangeHandler(e)} name='price' value={item.price} variant="outlined" />
                                        ...
                                        <TableCell align="left"><Box
                                            ...
                                            autoComplete="off"
                                        >
                                            <TextField size='small' onChange={(e) => onChangeHandler(e)} name='quantity' value={item.quantity} label="quantity." variant="outlined" />
                                        </Box></TableCell>
                ...
                <div className='bill_total_cover'>
                    ...
                    <div className='bill_total'>
                        <h3>Total : <span className='sub_total'>{billData?.total}</span></h3>
                        <h3 className='Tax_box'>discount : <span className='tax'>
                            <Box
                                component="form"
                                sx={{
                                    '& > :not(style)': { m: 1, width: '25ch' },
                                ...
                                autoComplete="off"
                            >
                                <TextField onChange={(e) => onChangeHandler(e)} name='discount' value={billData?.discount} label="discount" variant="outlined" />
                            </Box>
                        </span></h3>
                        <h3 className='discount_box'>Grand Total : <span><Box
                            component="form"
                            sx={{
                                '& > :not(style)': { m: 1, width: '25ch' },
                            }}
                            ...
                            autoComplete="off"
                        >
                            <TextField size='small' onChange={(e) => onChangeHandler(e)} name='g_total' value={billData.g_total} label="g_total" variant="outlined" />
                        </Box>
